...
from job_auth.views import user_signup, user_profile
from job_auth.forms import CustomAuthenticationForm
from django.contrib.auth.views import LoginView, LogoutView, PasswordChangeView, PasswordChangeDoneView, PasswordResetView, PasswordResetDoneView, PasswordResetConfirmView, PasswordResetCompleteView

urlpatterns = [
    #Signup and Login
    path('signup/', user_signup, name="user_signup"),
    path('login/', LoginView.as_view(template_name="job_auth/login.html", authentication_form=CustomAuthenticationForm,), name="login"),
